...
<template>
    <section id="contactoSection">
        ...
        <p class="text">Si deseas comunicarte con nosotros para realizar una <strong>consulta</strong> o solicitar un <strong>presupuesto</strong> personalizado, no dudes en contactarnos. Estamos a tu disposición para brindarte la mejor atención y asesoramiento.</p>
        <v-btn prepend-icon="mdi mdi-whatsapp" size="x-large" class="contactButton" @click="openWhatsapp">
            Contactanos
        </v-btn>
